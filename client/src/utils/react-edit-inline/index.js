      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn(
            this,
            (_ref =
              InlineEdit.__proto__ ||
              Object.getPrototypeOf(InlineEdit)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
        ...
        (_this.finishEditing = function () {
          if (
            _this.isInputValid(_this.state.text) &&
            _this.props.text !== _this.state.text
          ) {
            _this.commitEditing();
          } else if (
            _this.props.text === _this.state.text ||
        ...
        (_this.isInputValid = function (text) {
          return (
            text.length >= _this.state.minLength &&
            text.length <= _this.state.maxLength
          );
        }),
